...
export function UserProfile({ userFid, className }: UserProfileProps) {
  ...
  return (
    <div className={className}>
      ...
      <Card className="p-4 mb-4 card-professional">
        <div className="flex items-center gap-3">
          <Avatar className="h-12 w-12">
            <AvatarImage src={profile.pfpUrl} alt={getDisplayName()} />
            <AvatarFallback className="text-sm bg-gradient-to-r from-blue-600 to-blue-500 text-white">{getInitials()}</AvatarFallback>
          </Avatar>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-2 card-professional">
          <TabsTrigger value="overview" className="text-white data-[state=active]:bg-blue-800/50">Overview</TabsTrigger>
          <TabsTrigger value="voices" className="text-white data-[state=active]:bg-blue-800/50">Voices</TabsTrigger>
        </TabsList>
          ...
          <Card className="p-6 card-professional">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium text-white">{formatNumber(profile.stats.viewPoints)} XP</span>
              </div>
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-white">{formatNumber(profile.stats.likePoints)} XP</span>
              </div>
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-white">{formatNumber(profile.stats.commentPoints)} XP</span>
              </div>
            </div>
            ...
            <div className="mt-6 pt-4 border-t border-purple-500/30">
              ...
              <div className="flex flex-wrap gap-2">
                {profile.stats.totalVoices >= 1 && (
                  <Badge variant="secondary" className="flex items-center gap-1 bg-gradient-to-r from-blue-600 to-blue-500 text-white border-blue-400">
        ...
        <TabsContent value="voices" className="mt-6">
          <div className="space-y-4">
            {profile.voices.length === 0 ? (
              <Card className="p-6 text-center card-professional">
                <Mic className="h-12 w-12 mx-auto mb-4 text-blue-400" />
              ...
              profile.voices.map((voice) => (
                <Card key={voice.id} className="p-4 card-professional">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        {voice.isAnonymous && (
                          <Badge variant="secondary" className="text-xs bg-gradient-to-r from-blue-600 to-blue-500 text-white">
                            Anonymous
                          </Badge>
                        )}
                    ...
                    <div className="text-right text-sm text-blue-200">
                      ...
                      <div className="text-xs mt-2 text-blue-300">
                        {voice.views.length + (voice.likes.length * 5) + (voice.comments.length * 10)} XP
                      </div>
                    </div>
                  </div>
                </Card>
